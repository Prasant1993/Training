...
for n in min_child_weights:
    model = XGBClassifier(max_depth=6,n_estimators=260,min_child_weight=n,learning_rate=0.1,n_jobs=40)
    model.fit(X_train, y_train, sample_weight = w_train)
...
plt_A.grid()
plt_A.savefig('min_child_weight_optimization_endcap_16032019_predict.png')
...
plt_B.grid()
plt_B.savefig('min_child_weight_optimization_endcap_16032019_predict_proba.png')
