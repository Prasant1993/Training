...
for n in learning_rates:
    model = XGBClassifier(max_depth=6,n_estimators=260,learning_rate=n,n_jobs=30)
    model.fit(X_train, y_train, sample_weight = w_train)
...
plt_A.figure()
plt_A.plot(learning_rates, train_results_A, 'b', label='Train AUC')
plt_A.plot(learning_rates, test_results_A, 'r', label='Test AUC')
plt_A.legend(loc='lower right')
plt_A.ylabel('AUC Score')
plt_A.xlabel('Learning rates')
plt_A.title('AUC Score vs Learning rates')
plt_A.grid()
plt_A.savefig('learningrates_optimization_endcap_15032019_predict.png')
...
plt_B.figure()
plt_B.plot(learning_rates, train_results_B, 'b', label='Train AUC')
plt_B.plot(learning_rates, test_results_B, 'r', label='Test AUC')
plt_B.legend(loc='lower right')
plt_B.ylabel('AUC Score')
plt_B.xlabel('Learning rates')
plt_B.title('AUC Score vs Learning rates')
plt_B.grid()
plt_B.savefig('learningrates_optimization_endcap_15032019_predict_proba.png')
