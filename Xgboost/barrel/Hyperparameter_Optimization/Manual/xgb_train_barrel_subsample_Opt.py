...
for n in sample:
    model = XGBClassifier(max_depth=6,n_estimators=459,min_child_weight=1,gamma=0.0,subsample=n,learning_rate=0.1,n_jobs=40)
...
plt_A.grid()
plt_A.savefig('subsample_optimization_barrel_16032019_predict.png')
...
plt_B.grid()
plt_B.savefig('subsample_optimization_barrel_16032019_predict_proba.png')
