...
for n in colsample:
    model = XGBClassifier(max_depth=6,n_estimators=459,min_child_weight=1,gamma=0.0,subsample=1,colsample_bytree=n,learning_rate=0.1,
                          n_jobs=40)
...
plt_A.grid()
plt_A.savefig('colsample_bytree_optimization_barrel_16032019_predict.png')
...
plt_B.grid()
plt_B.savefig('colsample_bytree_optimization_barrel_16032019_predict_proba.png')
