...
for n in alpha:
    model = XGBClassifier(max_depth=6,n_estimators=459,min_child_weight=1,gamma=0.0,subsample=1,colsample_bytree=1,reg_alpha=n,
...
plt_A.grid()
plt_A.savefig('reg_alpha_optimization_barrel_16032019_predict.png')
...
plt_B.grid()
plt_B.savefig('reg_alpha_optimization_barrel_16032019_predict_proba.png')
