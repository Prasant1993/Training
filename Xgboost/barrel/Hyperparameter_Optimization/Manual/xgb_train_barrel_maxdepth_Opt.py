...
for n in max_depths:
    model = XGBClassifier(max_depth=n,n_estimators=459,learning_rate=0.1,n_jobs=40)
    model.fit(X_train, y_train, sample_weight = w_train)
...
plt_A.grid()
plt_A.savefig('max_depth_optimization_barrel_15032019_predict.png')
...
plt_B.xlabel('max_depths')
plt_B.title('AUC Score vs max_depth')
plt_B.grid()
plt_B.savefig('max_depth_optimization_barrel_15032019_predict_proba.png')
