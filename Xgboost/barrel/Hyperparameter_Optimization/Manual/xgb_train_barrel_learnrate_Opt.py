...
for n in learning_rates:
    model = XGBClassifier(max_depth=6,n_estimators=459,learning_rate=n,n_jobs=30)
    model.fit(X_train, y_train, sample_weight = w_train)
...
plt_A.grid()
plt_A.savefig('learningrates_optimization_barrel_15032019_predict.png')
...
plt_B.grid()
plt_B.savefig('learningrates_optimization_barrel_15032019_predict_proba.png')
