...
void TMVAClassification_preSelCuts_Run2_EE_woCorr( TString myMethodList = "" )
{
   ...
   TString outfileName( "Ntuple/PreVFP_PostVFP_separate_training/Post_VFP/PhoID_endcap_UL16_SA_Analysis_PostVFP_Added_photonIsoCorrection_train_details.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "PhoID_endcap_UL16_SA_Analysis_PostVFP", outputFile, "!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" );

   TMVA::DataLoader *dataloader = new TMVA::DataLoader("woCorr_EE_SATrain_BDTG_UL16_Added_photonIso_PostVFP");
   ...
   //dataloader->AddVariable( "scPhi", 'F' );
   dataloader->AddVariable( "rho", 'F' );  
   dataloader->AddVariable( "esEffSigmaRR", 'F' );
   dataloader->AddVariable("esEnergyOverRawE",'F');
    
   TString fname = "Ntuple/PreVFP_PostVFP_separate_training/Post_VFP/Output_SinglePhoton_GJet_UL16_PostVFP_photonIscorrectionEE_Added_Train_27042022.root";
