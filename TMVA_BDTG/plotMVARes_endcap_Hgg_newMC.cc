...
void plotMVARes(){
  ...
  fileNames[0]= "Ntuple/mvares_Hgg_phoId_EE_Rereco16_TMVA_SATrain_UL16_SATest_Added_PhotonIsocorrection.root";
  fileNames[1]= "Ntuple/mvares_Hgg_phoId_EE_UL16_TMVA_SATrain_UL16_SATest_Added_PhotonIsocorrection.root";
  ...
  //fileNames[2]= "Ntuple/mvares_Hgg_phoId_EE_RunIIAutumn18_xgboost_SATrain_woCorr_RnIIAutumn18_SATest_woCorr_M95_BDT.root";
  //fileNames[2]= "Ntuple/mvares_Hgg_phoId_EE_Kuntal_Fall17_SATrain_woCorr_RnIIAutumn18_SATest_woCorr_M95_BDT.root";
  ...
  */
  ...
  for(int i = 0; i < 2; i++){
    ...
    for(int k = 0; k < nCuts; k++){
      ...
      //std::fstream outfile;
      /*if(i==0){
        outfile.open("sigEff_bkgEff_endcap_LR0p05_UL2017_SATrain_UL2017_SATest_320_nbins100.txt",std::fstream::out | std::fstream::app);
        outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	} */

      /*if(i==1){
        outfile.open("sigEff_bkgEff_endcap_UL2017_XGB_SATrain_UL2017_SATest_320_nbins100.txt",std::fstream::out | std::fstream::app);
        outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	}*/

      /*if(i==2){
        outfile.open("sigEff_bkgEff_endcap_Fall17_SATrain_UL2017_SATest_320_nbins100.txt",std::fstream::out | std::fstream::app);
        outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	} */
  ...
  string mvaRes = "";
  mvaRes = "mvares_EE_phoId_UL16_SATest_320_nbins100";
  ...
  canName_RoC = "RoC_EE_phoId_UL16_SATest_320_nbins100_V2";
