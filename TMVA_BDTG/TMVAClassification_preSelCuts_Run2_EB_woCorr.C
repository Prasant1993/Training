...
void TMVAClassification_preSelCuts_Run2_EB_woCorr( TString myMethodList = "" )
{
   ...
   TString outfileName( "Ntuple/PreVFP_PostVFP_separate_training/Post_VFP/PhoID_barrel_UL16_SA_Analysis_Added_photonIsocorrection_train_details_PostVFP.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "PhoID_barrel_UL16_SA_Analysis_PostVFP", outputFile, "!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" );
  
   TMVA::DataLoader *dataloader = new TMVA::DataLoader("woCorr_EB_SATrain_BDTG_UL16_Added_photoniso_PostVFP");
