...
void plotMVARes(){
  ...
  // Ul2016 and rereco16 SA analysis TMVA train
  fileNames[0]= "Ntuple/mvares_Hgg_phoId_EB_Rereco16_TMVA_SATrain_UL16_SATest.root";
  fileNames[1]= "Ntuple/mvares_Hgg_phoId_EB_UL16_TMVA_SATrain_UL16_SATest.root";


  //fileNames[0]= "Ntuple/mvares_Hgg_phoId_EB_UL18_BDTG_TMVA_SATrain_SATest.root";
  //fileNames[1]= "Ntuple/mvares_Hgg_phoId_EB_UL18_XGB_SATrain_SATest.root";
  //fileNames[2]= "Ntuple/mvares_Hgg_phoId_EB_Autumn18_BDTG_TMVA_SATrain_SATest.root";

  //fileNames[0]= "Ntuple_UL2017/mvares_Hgg_phoId_EB_LR_0p05_UL2017_SATrain_UL2017_SATest_BDTG_14052020.root";
  //fileNames[0]= "Ntuple_Summer16/mvares_Hgg_phoId_EB_Summer16_LMTrain_Summer16_LMTest_BDTG_12062020.root";
  //fileNames[1]= "Ntuple_Summer16/mvares_Hgg_phoId_EB_Fall17_LMTrain_Summer16_LMTest_BDTG_12062020.root";
   //fileNames[2]= "Ntuple_UL2017/mvares_Hgg_phoId_EB_Fall17_kuntal_SATrain_UL2017_SATest_BDT_14052020.root";
   //fileNames[2]= "Ntuple/mvares_Hgg_phoId_EB_Xgboost_Autumn18_SATrain_woCorr_RunIIAutumn18_SATest_woCorr_M95_BDT.root";
   //fileNames[2]= "Ntuple/mvares_Hgg_phoId_EB_kuntal_Fall17_SATrain_woCorr_RunIIAutumn18_SATest_woCorr_M95_BDT.root";
   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

   // kuntal SATrain woHOE and SATest wHOE 

   //fileNames[1] = "/afs/cern.ch/work/p/prrout/public/BDT_training_11062019/CMSSW_9_4_9/src/SA_train_wHOE_M95_13062019/Ntuple/mvares_Hgg_phoId_94X_EB_wophoisoCorr_RunIIFall17_3_1_0_MCv2_SATrain_woHOE_SATest_wHOE_M95_woShowershape_nTree2k_BDT.root"; 
  
   // kuntal SATrain woHOE and SATest woHOE 
  //fileNames[1] = "/eos/user/p/prrout/public/Flashgg/PhotonIDMVA/Extended_Space_05062019/Ntuple_wHOE_08062019_corrected/mvares_Hgg_phoId_94X_EB_wophoisoCorr_RunIIFall17_3_1_0_MCv2_kuntalSATrain_PrasantSATest_woShowershape_nTree2k_BDTG.root";
  ...
  labelLeg_s[0] = "Sig:  Rereco16_TMVA";
  labelLeg_s[1] = "Sig:  UL2016_TMVA";
  ...
  */
  ...
  //labelLeg_s[4] = "Sig: 94X LMTest_LMTrain__LMWeight_nTree6k";
  ...
  labelLeg_b[0] = "Bkg: Rereco16_TMVA";
  labelLeg_b[1] = "Bkg: UL2016_TMVA";
  ...
  /*labelLeg_b[0] = "Bkg: 94X LMTrain_LMTest_nTree2k_30pT18";
  labelLeg_b[1] = "Bkg: 94X LMTrain_LMTest_nTree2k_18pT18";
  ...
  */
  ...
  labelLeg_RoC[0] = "Rereco16_TMVA";                                                                              
  labelLeg_RoC[1] = "UL2016_TMVA";
  ...
  */
  ...
  for(int i = 0; i < 2; i++){
    ...
    float sigEff[320], bkgEff[320], bkgrejEff[320];
    float cutsVal[320];
    ...
    for(int k = 0; k < nCuts; k++){
      ...
      //if(sigEff[k] >= 99.0) cout << " sigEff[k] = " << sigEff[k] <<  " bkgEff[k] = " << bkgEff[k] << " with a cut at " << mvaResCutVal << endl;
      //if(sigEff[k] > 0.79 && sigEff[k] < 0.91) cout << " sigEff[k] = " << sigEff[k] <<  " bkgEff[k] = " << bkgEff[k] << " with a cut at " << mvaResCutVal << endl;

      //std::fstream outfile;
      /*
      if(i==0){
	outfile.open("sigEff_bkgEff_barrel_LR0p05_UL2017_SATrain_UL2017_SATest_320_nbins100.txt",std::fstream::out | std::fstream::app);
	outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	}*/
      /*if(i==1){
        outfile.open("sigEff_bkgEff_barrel__UL2017_XGB_SATrain_UL2017_SATest_320_nbins100.txt",std::fstream::out | std::fstream::app);
        outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	}*/
      /*if(i==2){
	outfile.open("sigEff_bkgEff_barrel_Fall17_SATrain_UL2017_SATest_320_nbins100.txt",std::fstream::out | std::fstream::app);
	outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	}*/
    ...
    histo_s->GetYaxis()->SetTitle("Events");
    histo_s->SetMinimum(10);
    ...
    */
    ...
    if(i == 0){
      ...
      sigEff_vs_bkgEff->GetXaxis()->SetRangeUser(0.0,1.0);
  ...
  string mvaRes = "";
  mvaRes = "mvares_EB_phoId_UL16_SATest_320_nbins100";
  ...
  canName_RoC = "RoC_EB_phoId_UL16_SATest_320_nbins100_V2";
