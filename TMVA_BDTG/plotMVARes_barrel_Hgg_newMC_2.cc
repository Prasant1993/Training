...
void plotMVARes(){
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //fileNames[1]= "Ntuple/mvares_Hgg_phoId_EB_UL18_BDTG_TMVA_SATrain_SATest.root";
  //fileNames[0]= "Ntuple/mvares_Hgg_phoId_EB_UL17_TMVA_SATrain_UL18_SATest.root";
  ...
  //fileNames[1]= "Ntuple_Summer16/mvares_Hgg_phoId_EB_Fall17_LMTrain_Summer16_LMTest_BDTG_12062020.root";
   ...
   //fileNames[1]= "Ntuple/mvares_Hgg_phoId_EB_Xgboost_Autumn18_SATrain_woCorr_RunIIAutumn18_SATest_woCorr_M95_BDT.root";
  ...
  //labelLeg_s[2] = "Sig:  ReReco2018_TMVA";
  ...
  */
  ...
  //labelLeg_b[2] = "Bkg: ReReco2018_TMVA";
  ...
  */
  ...
  for(int i = 0; i < 2; i++){
    ...
    TH1F * histo_s = new TH1F ("histo_s","histo_s",2000,-1.0,1.0);
    TH1F * histo_b = new TH1F ("histo_b","histo_b",2000,-1.0,1.0);
    ...
    for(int k = 0; k < nCuts; k++){
      ...
      //if(mvaResCutVal > -0.4) cout << " sigEff[k] = " << sigEff[k] <<  " bkgEff[k] = " << bkgEff[k] << " with a cut at " << mvaResCutVal << endl;
       std::fstream outfile;
      if(i==0){
	outfile.open("sigEff_bkgEff_barrel_Rereco16_TMVA_SATrain_UL16_SATest_20000_nbins2000.txt",std::fstream::out | std::fstream::app);
	outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	} 
      if(i==1){
        outfile.open("sigEff_bkgEff_barrel_UL16_TMVA_SATrain_UL16_SATest_20000_nbins2000.txt",std::fstream::out | std::fstream::app);
        outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	}
	/*if(i==2){
	outfile.open("sigEff_bkgEff_barrel_ReReco18_TMVA_SATrain_UL18_SATest_20000_nbins2000.txt",std::fstream::out | std::fstream::app);
	outfile << bkgEff[k] <<'\t'<< sigEff[k] <<'\t'<< bkgrejEff[k] <<'\t'<<  mvaResCutVal << endl;
	} 
      */
    ...
    histo_s->GetYaxis()->SetTitle("Events/0.01");
  ...
  string mvaRes = "";
  mvaRes = "mvares_EB_phoId_UL16_SATest_20000_nbins_2000_V2";
  ...
  canName_RoC = "RoC_EB_phoId_UL16_SATest_20000_nbins_2000_V2";
